...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/typing-compat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13237&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/typing-compat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `typing-compat` can be installed with:

```
conda install typing-compat
```

It is possible to list all of the versions of `typing-compat` available on your platform with:
